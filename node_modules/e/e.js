...
E = (function(){
	...
	function addOne(uid,componentName,component){
		...
		router.components[componentName] = router.components[componentName] || {}

		router.components[componentName][uid] =  _.extend(current,component)
	}
	...
	function get(componentName,entity){
		...
		function getAll(componentName){
			var result = router.components[componentName];
			if(result){
				return _(result)
			} else {
				return _([])
